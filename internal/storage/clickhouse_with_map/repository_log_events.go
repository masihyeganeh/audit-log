...
func (r *repository) LogEvents(ctx context.Context, events []service.Event) error {
	query := `
INSERT INTO events_with_map (event_time, event_type, common_field_1, common_field_2, fields)
VALUES ($1,$2,$3,$4,$5);
`
	...
	for _, evt := range events {
		...
		_, err = statement.Exec(
			eventToStore.EventTime, eventToStore.EventType, eventToStore.CommonField1, eventToStore.CommonField2, eventToStore.Fields,
		)
		if err != nil {
